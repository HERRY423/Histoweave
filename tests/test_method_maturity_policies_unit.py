...
def test_maturity_ranks_are_ordered() -> None:
    ...
    assert ranks[MethodMaturity.PRODUCTION] < ranks[MethodMaturity.CONTRACT_VALIDATED]
    assert ranks[MethodMaturity.CONTRACT_VALIDATED] < ranks[MethodMaturity.VALIDATED]
